...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Okt 2019 pada 07.14
...
('PS18102019-02', 'tahu', 10, 1),
('PS18102019-02', 'jajs', 90, 1),
('PS18102019-03', 'tahu', 10, 1),
('PS18102019-03', 'jajs', 90, 1),
('PS18102019-04', 'tahu', 10, 1),
('PS18102019-04', 'jajs', 90, 1),
('PS18102019-05', 'sadf', 90, 9),
('PS18102019-06', 'sadf', 90, 9),
('PS18102019-07', 'sadf', 90, 9),
('PS18102019-08', 'sadf', 90, 9),
('PS18102019-09', 'sadf', 90, 9),
('PS18102019-10', 'sadf', 90, 9),
('PS18102019-11', 'sadf', 90, 9),
('PS18102019-12', 'sadf', 90, 9),
('PS19102019-01', 'siap wes', 90, 9),
('PS19102019-01', 'anggi', 100, 1),
('PS19102019-02', 'anggi', 100, 1),
('PS19102019-03', 'anggi', 100, 1),
('PS19102019-04', 'anggi', 100, 1),
('PS19102019-04', 'pentol', 100, 1),
('PS19102019-05', 'tahu', 10, 1),
('PS19102019-06', 'tahu', 10, 1),
('PS19102019-07', 'tahu', 10, 1),
('PS19102019-08', 'tahu', 10, 1),
('PS19102019-09', 'tahu', 10, 1),
('PS19102019-10', 'aggg', 10, 1);
...
('PS18102019-02', '1', 100, 100, '2019-10-18', 'P2', '2019-11-10'),
('PS18102019-03', '1', 100, 100, '2019-10-18', 'P2', '2020-01-10'),
('PS18102019-04', '1', 100, 100, '2019-10-18', 'P2', '2020-01-10'),
('PS18102019-05', '1', 810, 810, '2019-10-18', 'P2', '1970-01-01'),
('PS18102019-06', '1', 810, 810, '2019-10-18', 'P2', '2010-02-10'),
('PS18102019-07', '1', 810, 1000, '2019-10-18', 'P2', '2019-02-10'),
('PS18102019-08', '1', 810, 810, '2019-10-18', 'P2', '2019-02-10'),
('PS18102019-09', '1', 810, 810, '2019-10-18', 'P2', '2019-10-10'),
('PS18102019-10', '1', 810, 810, '2019-10-18', 'P2', '1970-01-01'),
('PS18102019-11', '1', 810, 810, '2019-10-18', 'P2', '1970-01-01'),
('PS18102019-12', '1', 810, 810, '2019-10-18', 'P2', '1970-01-01'),
('PS19102019-01', '1', 910, 1000, '2019-10-19', 'P2', '2019-10-09'),
('PS19102019-02', '1', 100, 100, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-03', '1', 100, 100, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-04', '1', 200, 200, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-05', '1', 10, 10, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-06', '1', 10, 100, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-07', '1', 10, 10, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-08', '1', 10, 10, '2019-10-19', 'P2', '2019-02-10'),
('PS19102019-09', '1', 10, 10, '2019-10-19', 'P2', '1970-01-01'),
('PS19102019-10', '1', 10, 10, '2019-10-19', 'P2', '1970-01-01');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `detg`  AS  select `pemesanan`.`id_pemesanan` AS `id_pemesanan`,`pemesanan`.`tanggal` AS `tanggal`,`pelanggan`.`nama` AS `nama`,`pelanggan`.`hp` AS `hp`,`pelanggan`.`alamat` AS `alamat`,`pemesanan`.`total` AS `total`,`pemesanan`.`bayar` AS `bayar`,`tb_user`.`username` AS `username`,`pemesanan`.`ambil` AS `ambil` from (((`pemesanan` join `detail_pemesanan`) join `pelanggan`) join `tb_user`) where ((`pemesanan`.`id_pemesanan` = `detail_pemesanan`.`id_pemesanan`) and (`pemesanan`.`id_pelanggan` = `pelanggan`.`id_pelanggan`) and (`pemesanan`.`id_user` = `tb_user`.`id_user`)) group by `pemesanan`.`id_pemesanan` ;
